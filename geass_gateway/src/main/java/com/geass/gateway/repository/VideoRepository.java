...
public class VideoRepository {
    ...
    public BaseResponse<Map<String, Object>> getByID(Object body) {
        return remoteCaller.post(
            serviceUrlConfig.media(ApiPaths.VIDEO_ID),
            body,
    ...
    public BaseResponse<Map<String, Object>> getByType(Object body) {
        return remoteCaller.post(
            serviceUrlConfig.media(ApiPaths.VIDEO_TYPE),
            body,
            new ParameterizedTypeReference<BaseResponse<Map<String, Object>>>() {}
        );
    }
    ...
    public BaseResponse<Map<String, Object>> searchActors(Object body) {
        return remoteCaller.post(
            serviceUrlConfig.media(ApiPaths.VIDEO_SEARCH_ACTORS),
            body,
            new ParameterizedTypeReference<BaseResponse<Map<String, Object>>>() {}
        );
    }
    ...
    public BaseResponse<Map<String, Object>> searchName(Object body) {
        return remoteCaller.post(
            serviceUrlConfig.media(ApiPaths.VIDEO_SEARCH_NAME),
            body,
            new ParameterizedTypeReference<BaseResponse<Map<String, Object>>>() {}
        );
    }
    ...
    public BaseResponse<Map<String, Object>> sortByFavorite(Object body) {
        return remoteCaller.post(
            serviceUrlConfig.media(ApiPaths.VIDEO_SORT_FAVORITE),
            body,
            new ParameterizedTypeReference<BaseResponse<Map<String, Object>>>() {}
        );
    }
    ...
    public BaseResponse<Map<String, Object>> sortByView(Object body) {
        return remoteCaller.post(
            serviceUrlConfig.media(ApiPaths.VIDEO_SORT_VIEW),
            body,
            new ParameterizedTypeReference<BaseResponse<Map<String, Object>>>() {}
        );
    }
